export default function LightGreenHero() {
  return (
    <>
      <div className="bg-gradient-to-b from-[#E0F4E6] to-[#A8E0D6] relative">
        <section className="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div className="max-w-xl mx-auto text-center">
              <h1 className="text-4xl font-bold sm:text-6xl">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#007E85] to-[#5be066]">
                  Simplified credit cards for students
                </span>
              </h1>
              <p className="mt-5 text-base text-gray-800 sm:text-xl">
              ...
              <a
                href="#"
                title=""
                className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-primary rounded-lg sm:mt-16 hover:opacity-50 focus:"
                role="button"
              >
                Apply for free
                <svg
              ...
              <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M17 4H3C1.89543 4 1 4.89543 1 6V8H19V6C19 4.89543 18.1046 4 17 4Z"
                      stroke="#28CC9D"
                      strokeWidth="1.5"
                      strokeMiterlimit="10"
                      strokeLinecap="round"
